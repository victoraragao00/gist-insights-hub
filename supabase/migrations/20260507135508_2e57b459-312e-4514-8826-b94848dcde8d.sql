ALTER TABLE projects
  ADD COLUMN IF NOT EXISTS hours_estimated NUMERIC(6,2);

COMMENT ON COLUMN projects.hours_estimated IS
  'Horas planejadas definidas manualmente pelo gestor. Comparadas com horas reais em get_project_stats.';
